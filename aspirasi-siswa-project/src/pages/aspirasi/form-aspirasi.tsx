        ...
        <div className="mt-14 w-full md:w-3xl" >
            <form action="" className="flex flex-col gap-4" >
                ...
                <div className="flex flex-col gap-1" >
                    ...
                    <input type="text" className="px-4 py-2 rounded-lg bg-white shadow-md transition-colors duration-200 focus:outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400 border-yellow-400" placeholder="nama Anda" />
                </div>
                {/* pesan */}
                <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-1 relative" >
                    ...
                    <input type="file" className="px-4 pl-12 py-2 rounded-lg bg-white shadow-md transition-colors duration-200 focus:outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400 border-yellow-400 text-gray-400" />
